...
const Plugin = () => {
  ...
  const { data, error } = useSWRImmutable(
    () => name && `${process.env.baseUrl}/plugins/${name}`,
    fetcher
  )
          ...
          <DefinitionList>
            <div className="plugin-details-dl">
              <div className="plugin-details-left">
                <DefinitionListItem title="Type">
                  <Label>
                    <PluginType type={data.type} />
                  </Label>
                </DefinitionListItem>
                <DefinitionListItem title="Script file">
                  {data.scriptFile}
                </DefinitionListItem>
                {data.supportedRuntime && (
                  <DefinitionListItem title="Supported runtime">
                    {data.supportedRuntime}
                  </DefinitionListItem>
                )}
                {data.supportedDataType && (
                  <DefinitionListItem title="Supported data type">
                    {data.supportedDataType}
                  </DefinitionListItem>
                )}
              </div>
              <div className="plugin-details-right">
                <DefinitionListItem title="Version">
                  {data.version}
                </DefinitionListItem>
              </div>
            </div>
