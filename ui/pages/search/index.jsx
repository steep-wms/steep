...
import {
  hasAnyTypeExpression,
  hasTypeExpression,
  removeAllTypeExpressions,
  hasLocator,
  toggleLocator
} from "../../components/lib/search-query"
...
const Search = () => {
  ...
  const { data: counts, error: countError } = useSWRImmutable(
    ...
    async url => {
      if (
        results.counts.workflow >= 1000 ||
        results.counts.processChain >= 1000
      ) {
  ...
  let sidebarType = results && (
    <ul>
      <li
        className={classNames("sidebar-list-item", {
          active: !hasAnyTypeExpression(router.query.q)
        })}
      ...
      >
        ...
        {counts && (
          <div className="label">
            <Label small>{formatCount(counts.total)}</Label>
          </div>
        )}
      </li>
      <li
        className={classNames("sidebar-list-item", {
          active: hasTypeExpression(router.query.q, "workflow")
        })}
        onClick={() =>
          pushQuery(removeAllTypeExpressions(router.query.q) + " is:workflow")
        }
      >
        <div className="active-icon">
          <ArrowRight size="1rem" />
        ...
        {counts && (
          <div className="label">
            <Label small>{formatCount(counts.workflow)}</Label>
          </div>
        )}
      </li>
      <li
        className={classNames("sidebar-list-item", {
          active: hasTypeExpression(router.query.q, "processchain")
        })}
        onClick={() =>
          pushQuery(
            removeAllTypeExpressions(router.query.q) + " is:processchain"
          )
        }
      >
        <div className="active-icon">
        ...
        {counts && (
          <div className="label">
            <Label small>{formatCount(counts.processChain)}</Label>
          </div>
        )}
      </li>
  ...
  let sidebarSearchIn = results && (
    <ul>
      <li className="sidebar-list-item heading">Search in:</li>
      <li
        className={classNames("sidebar-list-item", {
          active: hasLocator(router.query.q, "id")
        })}
      ...
      <li
        className={classNames("sidebar-list-item", {
          active: hasLocator(router.query.q, "name")
        })}
      ...
      <li
        className={classNames("sidebar-list-item", {
          active: hasLocator(router.query.q, "status")
        })}
      ...
      <li
        className={classNames("sidebar-list-item", {
          active: hasLocator(router.query.q, "source")
        })}
      ...
      <li
        className={classNames("sidebar-list-item", {
          active: hasLocator(router.query.q, "rcs")
        })}
      ...
      <li
        className={classNames("sidebar-list-item", {
          active: hasLocator(router.query.q, "error")
        })}
      ...
      <li
        className={classNames("sidebar-list-item", {
          active: hasLocator(router.query.q, "start")
        })}
      ...
      <li
        className={classNames("sidebar-list-item", {
          active: hasLocator(router.query.q, "end")
        })}
        ...
        <div className="search-body-container">
          ...
          {results && (
            <div className="sidebar">
              ...
              <div className="sidebar-expanded">{sidebarType}</div>
              <div className="sidebar-dropdown">
                <DropDown
                  title="Search in"
                  small={true}
                  forceTitleVisible={true}
                >
                  {sidebarSearchIn}
                </DropDown>
              </div>
              <div className="sidebar-expanded">{sidebarSearchIn}</div>
            </div>
          )}
