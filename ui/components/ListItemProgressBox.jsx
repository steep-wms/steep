...
const ListItemProgressBox = ({ progress, deleted = false }) => {
  ...
  switch (progress.status) {
    ...
    case "UP":
      ...
      icon = (
        <Activity
          className={classNames("feather", "up", resolvedStyles.className)}
        />
      )
      break
    ...
    case "LEAVING":
      ...
      icon = (
        <Moon
          className={classNames("feather", "leaving", resolvedStyles.className)}
        />
      )
      break
    ...
    case "RUNNING": {
      ...
      icon = (
        <RotateCw
          className={classNames("feather", "running", resolvedStyles.className)}
        />
      )
      break
    }
    ...
    case "PAUSED":
      ...
      icon = (
        <PauseCircle
          className={classNames("feather", "idle", resolvedStyles.className)}
        />
      )
      break
    ...
    case "LEFT":
      ...
      icon = (
        <Power
          className={classNames("feather", "left", resolvedStyles.className)}
        />
      )
      break
    ...
    case "SUCCESS":
      ...
      icon = (
        <CheckCircle
          className={classNames("feather", "success", resolvedStyles.className)}
        />
      )
      break
    ...
    default:
      ...
      icon = (
        <XCircle
          className={classNames("feather", "error", resolvedStyles.className)}
        />
      )
      break
  }
  ...
  if (deleted) {
    ...
    icon = (
      <Trash2 className={classNames("feather", resolvedStyles.className)} />
    )
  }
  ...
  return (
    <div className="list-item-progress-box">
      {icon}
      <div>
        <strong>{progress.title || defaultTitle}</strong>
        <br />
