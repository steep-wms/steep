    ...
    (more = false, callback) => {
      async function handleResponse(r) {
        ...
        if (r.status === 404) {
          ...
          contentRange.current = parseRangeHeader(
            r.headers.get("x-content-range")
          )
      ...
      if (more) {
        bytes =
          Math.max(0, contentRange.current.first + bytes) +
          "-" +
            ...
            setError(
              <Alert error>
                ...
                <ul>
                  ...
                  <li>
                    The agent that has executed the process chain is not
                    available anymore
                  </li>
                  <li>
                    Process chain logging is disabled in Steep&rsquo;s
                    configuration
                  </li>
                </ul>
              </Alert>
