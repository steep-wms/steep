  ...
  return (
    <header>
      <Head>
        ...
        <link rel="icon" type="image/x-icon" href={`${router.basePath}/favicons/favicon.ico`}/>
        ...
        <link rel="manifest" href={`${router.basePath}/favicons/manifest.webmanifest`}/>
        ...
        <link rel="apple-touch-startup-image" media="(device-width: 390px) and (device-height: 844px) and (-webkit-device-pixel-ratio: 3) and (orientation: portrait)" href={`${router.basePath}/favicons/apple-touch-startup-image-1170x2532.png`}/>
        <link rel="apple-touch-startup-image" media="(device-width: 390px) and (device-height: 844px) and (-webkit-device-pixel-ratio: 3) and (orientation: landscape)" href={`${router.basePath}/favicons/apple-touch-startup-image-2532x1170.png`}/>
        ...
        <link rel="apple-touch-startup-image" media="(device-width: 428px) and (device-height: 926px) and (-webkit-device-pixel-ratio: 3) and (orientation: portrait)" href={`${router.basePath}/favicons/apple-touch-startup-image-1284x2778.png`}/>
        <link rel="apple-touch-startup-image" media="(device-width: 428px) and (device-height: 926px) and (-webkit-device-pixel-ratio: 3) and (orientation: landscape)" href={`${router.basePath}/favicons/apple-touch-startup-image-2778x1284.png`}/>
