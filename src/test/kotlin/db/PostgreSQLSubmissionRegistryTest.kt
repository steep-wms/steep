...
class PostgreSQLSubmissionRegistryTest : SubmissionRegistryTest() {
  companion object {
     ...
     */
    private const val URL = "jdbc:tc:postgresql:10.5://hostname/databasename?TC_DAEMON=true"

    @AfterAll
    @JvmStatic
    fun shutdown() {
      // kill the test container automatically created by Testcontainers as
      // soon as all tests have finished
