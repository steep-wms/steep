...
dependencies {
    ...
    implementation("io.projectreactor:reactor-core:3.5.0") // necessary for reactive MongoDB driver
    ...
    testImplementation("de.flapdoodle.embed:de.flapdoodle.embed.mongo:4.1.0")
